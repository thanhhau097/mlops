...
def train_model(config: dict):
    ...
    train_dataset = MNISTDataset(
        root_folder="/home/lionel/Desktop/MLE/mlops/data/mnist/train", transform=transform
    )
    val_dataset = MNISTDataset(
        root_folder="/home/lionel/Desktop/MLE/mlops/data/mnist/test", transform=transform
    )
...
if __name__ == "__main__":
    train_model(config={"lr": 0.001, "momentum": 0.9})
    # hyperparams_opt()
